...
import { forgotPasswordComponent } from "./shared/features/forget-password/forget-password.component";
...
const routes: Routes = [
  ...
  {
    path: "form_entry/:_id",
    component: EntriesDetailsComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: "update_form/:_id/:entry_id",
    component: DynamicFormComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: "create-new-form",
    component: NewFormCreateComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: "form-update/:_id",
    component: FormUpadateComponent,
    canActivate: [AuthenticationGuard],
  },
