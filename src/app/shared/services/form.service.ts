...
export class FormService {
  ...
  submitFormFieldsValue(newBody: any) {
    ...
    return this.http.post(this.BASE_URL + "forms/saveDetailsNew", newBody, {
      headers: headers,
    });
  }
  ...
  getFormFieldsEntries(id: any) {
    return this.apiService.get(
      this.BASE_URL + "forms/GetAllFormEntries?form_id=" + id
    );
  }

  FormFieldsEntrieDelete(entry_id: any) {
    return this.apiService.delete(
      this.BASE_URL + "forms/DeleteEntries?entry_id=" + entry_id
    );
  }

  getFromAndEntriesById(form_id: any, entry_id: any) {
    return this.apiService.get(
      this.BASE_URL +
        "forms/GetEntriesById?form_id=" +
        form_id +
        "&entry_id=" +
        entry_id
    );
  ...
  getListEntriesById(form_id: any) {
    return this.apiService.get(
      this.BASE_URL + "forms/GetAllFormEntriesNew?form_id=" + form_id
    );
  }
  ...
  updateFormEntry(newBody: any) {
    ...
    return this.http.put(this.BASE_URL + "forms/UpdateEntries", newBody, {
      headers: headers,
    });
  }
