...
export class NewSubFormCreateComponent implements OnInit {
  ...
  setUpdateValue() {
    ...
    this.validationForm.controls["field_name"].setValue(
      this.updateField.field_name
    );
    this.validationForm.controls["field_label"].setValue(
      this.updateField.field_label
    );
    setTimeout(() => {
  ...
  onSubmit() {
    ...
    this.fieldSet.field_label =
      this.validationForm.controls["field_label"].value;
    ...
    if (this.validationForm.controls["maxLength"].value) {
      this.dataSet["maxLength"] =
        this.validationForm.controls["maxLengthValue"].value;
    }
    if (this.validationForm.controls["minLength"].value) {
      this.dataSet["minLength"] =
        this.validationForm.controls["minLengthValue"].value;
    }
    this.fieldSet.validation = this.dataSet;

    if (
      this.validationForm.controls["field_type"].value === "radio" ||
      ...
      if (this.fiieldsValues) {
        ...
        this.formService.showSuccess(
          this.messageContent.successMessage,
